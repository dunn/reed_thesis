...
Presumably, then, the lump is also produced by means of the
...
histories.  But how can we do this without assuming eternalism?

% THEIR MODAL PROPERTIES!!!

\subsection{Referring to chairs}
\label{chair-ref}
I suggest that, as we identified groups like the Supreme Court with
different sets at different times, so we identify things like chairs
with different sums at different times.  Terms like `chair' will be
used to express a relation between a sum and a time.
