...
College womens' rugby team, and my family.  There is at least some
...
parthood.  For example, Peter van Inwagen provides the following
definitions:
...
van inwagen's problem with universalism

How I am using the term `part' will therefore influence how
...
such that it is composed of the $y$s''?  Or are there different {\em
  kinds} of composition, producing different kinds of things?

I will look at three different theories that provide different answers
to these questions.  Section \ref{fine-h} will discuss Kit Fine's
...
theories is that they entail the existence of a plurality of
...
\label{fine-h}
An outline of Kit Fine's {\em hylomorphic} theory is presented in his
...
definition of a mereological sum: LKFKLJDFJLKF.  But
...
of the property of being a statue:
...
\label{h-part}
variable embodiments and conceptual containers

\subsection{Problems with the first theory}
\label{problems1}
qua objects = explosion

\subsection{Second theory: tensed mereology}
\label{hovda}
ornk
...
\subsection{Third theory: composition operators}
\label{fine-c}
...
\section{Can the two theories explain what we believe?}
\label{explain2}
...
but they do make other unexpected claims that conflict with certain of
our beliefs.  Therefore, the theories should be supplemented with
