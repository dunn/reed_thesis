...
\label{4d}
So far I have not been supposing {\em four-dimensionalism}.  I have
assumed neither that things are composed of temporal as well as
...
second of a puppy's existence in 2020.

The objects composed of these temporal slices are mereological sums in
the classical sense.  Call the object referenced above `Krupkin'.
Because the past and future exist (we're assuming eternalism), Krupkin
always has the same parts.  Strictly speaking, it doesn't ever change
its parts.  In 1991 it is true to say ``the Kremlin is not {\em now}
part of Krupkin'', but it is not true to say ``the Kremlin is not part
of Krupkin.
...
property of having had a puppy as a part.  Therefore Krupkin cannot
lose a part.
...
\subsection{Four-dimensional solutions and four-dimensional problems}
\label{4ds}
...
four-dimensionalism that does it disprove the three theories
...
and what that thing's (or things') modal properties are depends upon
whether I squash or smash it.  This seems highly implausible.  By
choosing to squash the statue rather than smash it, I thereby {\em
...
instead assumed indeterminism, they would presumably have to say that,
