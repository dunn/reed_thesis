...
function, but it has as parts (in some sense) whatever objects the
function assigns to the present time.
...
to a time.  How does this lead to co-location?
...
$\sum$ will be operating on two different functions, it will produce
...
examined appears to entail the same.
