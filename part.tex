...
the chair that possessed the part.  Even if ``that chair lost a leg
today'' is literally false, {\em what I mean} is that the sum that
yesterday satisfied the (conventional) criteria for being the referent
of ``that chair'' had one more leg than the sum that satisfies the
criteria today.
