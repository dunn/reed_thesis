...
{[}Problems with formal mereology and supplementation?{]}
...
the statue and the lump, they seem to be co-located things.  Thus with
Fine's new theory, we get the same `explosion of reality' that we get
with the previous two theories.

Just as we initially considered identifying groups with sets, so we
can consider identifying things like statues with sums.  Sums, like
sets, cannot change their parts (see section \ref{change}).  Ordinary
things like statues, however, {\em can} apparently change their parts.
If I break the nose of my statue, I can replace it.  Do I thereby have
a new statue?  It seems I do not; rather, I have fixed my old statue.
...
embodients (section \ref{fine-h}) allowed for `qua-objects' such as
...
Merricks' explantion of why we believe that there are chairs (section
