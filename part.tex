...
completely overlapping (co-located) objects; in some cases, completely
...
These strange consequences---that passengers are distinct from people,
and cannot actually think---coupled with the `explosion of reality' is
...
I do not know how to answer for Fine.  In section \ref{set-id},
