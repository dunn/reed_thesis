...
%%  more here.  why shouldn't we just tollens this conclusion?  why
%%  shouldn't we be looking at the history of the table?  why take
%%  this 'snapshot' as important?

There is another argument for the same conclusion.  If a chair can
remain numerically identical after losing a part, it is difficult to
