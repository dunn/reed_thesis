...
\chapter{Introduction: What do I mean when I say there are chairs?}
...
\chapterpig{What does it take to be a chair?}
\input{merricks}

\chapter{How do chairs persist over time?}
\chapterpig{How do chairs persist over time?}
\input{part}

%% \chapter{Is `chair' incoherent?}
%% \chapterpig{Is `chair' incoherent?}
%% \input{unger}
