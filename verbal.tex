...
Sider seem to reject.  Without explicitly endorsing Hirsch's theory of
...
\citeyearpar[171]{sider2011d}.  He thereby makes room for a notion of
``fundamental quantification''; only by using ``fundamental terms''
like $\mathcal{F} ( \exists x Cx )$ can we express the proposition
that there are chairs (where $\mathcal{F}$ means `it is fundamentally
the case that').
