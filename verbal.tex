...
%% ``do you have the time?'', I imply that I would like to know the time,
%% although I do not actually say that I would like to know the time.  I
%% {\em generate an implicature} to that effect.

%% When what I say implies something, it does not necessarily also {\em
%%   entail} it.  If I inform you that ``some of the employees were
%% drunk'', I imply that not {\em all} were drunk---that some were not
%% drunk.  But what I said does not entail this; what I said is
%% compatible with it being the case that all the employees were drunk.
%% A reliable way to test whether something is implied or entailed is to
%% see if it can be {\em cancelled}.  Implicatures can be cancelled, but
...
%% myself, because I have tried to cancel
