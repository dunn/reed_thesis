...
\stage{Lauren}{(enters)}{Every bottle of beer on the planet has been
  abducted by aliens!}
...
\label{fun-quant}
Sider and Hirsch both occasionally claim that quantificational phrases
like ``there is a table'' might actually {\em mean} something other
than that there is a table.  This is a mistake.  Examples from Hirsch
are documented in section \ref{charity}; here is an example from
Sider:
