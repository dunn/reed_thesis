...
%\begin{inq}
%%\begin{description}[labelindent=10pt]
%	\textbf{quine}, v. To deny resolutely the existence or importance of something real or significant.%\footnotemark
%	\footnote{This is of course from the {\em Philosophical Lexicon}~\citep{dennett2008}.}
%%\end{description}
%\end{inq}%\vspace{5pt}
%%\footnotetext{This is of course from the {\em Philosophical Lexicon}~\citep{dennett2008}.}
