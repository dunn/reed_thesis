...
nihilism given above (he does not discuss Markosian's theory).  He
also rejects a number of other answers to the Special Composition
Question.  Some are too strong: `some $x$s compose a $y$ iff the $x$s
...
\ref{verbal}, incorrect.  If van Inwagen is adopting a similar
position, then we can predict that it will be wrong too.
...
chairs at all.  Like van Inwagen's, I think his arguments do not
