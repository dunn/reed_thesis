...
\begin{enumerate}
  \item Epistemicism seems to involve a rejection of the second thesis
    ...
    As Wright mentions above in section \ref{comp}, it is not obvious
    that we do use vague terms in an entirely consistent manner.
    Given this, it is implausible that such a pattern of use could
    determine the application-criteria of vague terms in a fully
