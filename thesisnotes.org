...
'analyticities' or definitional biconditionals.  For example, van
Inwagen claims that chairs necessarily do not exist because there is
no true proposition of the form "y (a chair) is composed of the xs iff
---------".  Unger thinks that ordinary terms are "incoherent" and
"have no application" because there are no necessary and sufficient
conditions for being a chair.  He brings this out with a sorites
'paradox': if we take an ordinary chair and remove an insignificant
amount of matter, it is still a chair.  But if we keep removing
matter, eventually there will not be a chair.  Nothing in the meaning
of 'chair' tells us at what point the chair ceases to exist.  Unger's
conclusion is that "either there is always a chair, or there never
was".  He concludes this because he assumes that if 'chair' is to be a
coherent term with 'application', then it must be possible to give an
analysis of 'chair' that supplies us with the necessary and sufficient
...
model, attempts to analyse 'chair' and so deduce the conditions of its
application.  He cannot deduce any necessary and sufficient
conditions, and so cannot find anything to apply the term to.  He
concludes that the term, having no application, is incoherent.  But of
course he's going about things in the wrong way.  As Austin points out
in the case of pigs, we learn the meaning of 'chair' not by receiving
a set of necessary and sufficient conditions of application, but by
being _shown_ what things the term 'chair' is applied to.  "_That's_ a
chair."  This is a perfectly familiar way of learning how to use a
word, and a word that is introduced this way is perfectly meaningful.
Unger and van Inwagen illegitimately suppose that a term must be
amenable to the sort of analytic definition that goes "x is a chair
iff --------".  But in fact few ordinary things have such definitions:
it does not follow that they do not exist nonetheless.  Unger and van
Inwagen have to show that all that exist is those things that _do_
have analytic definitions.  (Van Inwagen might be in trouble here with
his 'definition' of life.)
** Meeting notes
*** <2011-09-29 Fri>
...
> ``It is not, as Warnock's language suggests, that we can stop
  hedging around if there is a good case for coming right out with it;
  the fact is that we don't {\em begin} to hedge unless there is some
  special reason for doing so, something a bit strange and off-colour
  about the particular situation''~\cite[142]{austin-ss}
