...
1. there are lumpkins
2. if lumpkins, then things composed
3. things composed

- [ ] change to 'archipelagos'
**** TODO visual evidence and rhetoric
- [ ] motivate universalism more slowly (structure)
...
- [ ] is using a team name to refer to members non-literal (doesn't
  matter; we _do_ use it to refer singly to something that is not the
  members)
**** TODO fine
- [ ] part/whole 'metaphor'?
- [ ] emphasize the common application of a composition operator
- [ ] temporal operators (re-apply at times, or different temporally
  indexed operators)?
**** TODO sets and groups
- [ ] Uzquiano's conditions for groups (contingency)
- [ ] 'the temperature is rising'---does 'is rising' apply to one
  thing or a series?
- [ ] the presidency?
- [ ] 'the committee was formed in 1976'; literally false?
- [ ] emphasize the disjunction re: groups (either explosion of
