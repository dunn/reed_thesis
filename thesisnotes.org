...
- [ ] sider's temporal counterparts applied to essentialism
  - [ ] 'chair-counterpart' relation
  - [ ] names for things and sortal conventions
  - [ ] "if 'N' is a name for a chair, then (if 'N' refers to x at t,
...
- [ ] what does the essentialist _mean_?
  - [ ] what is the relation between x at t and y at t2 (the
    'persisting chair'
  - [ ] persisting-chair-functions?  what we refer to is determined by
