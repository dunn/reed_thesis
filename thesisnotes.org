...
- [ ] how _does_ paul's theory deal with co-located thinkers?
  - because there are no co-located _diachronic_ fusions
- [ ] why do we need generative applications in the argument for many
  kinds?
**** TODO mereology
...
- [-] restricted quantifiers
  - [ ] beer isn't just abducted, it is _destroyed!_
...
**** questions for paul
1. what are synchronic fusions and how do they persist over time?
2. are diachronic fusions identical to synchronic fusions?  are there
   _two_ kinds of things, or just one?
**** TODO essentialism
