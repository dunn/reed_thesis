...
- [ ] Sider's temporal counterpart
  - [ ] sider's two senses of 'it existed'; stages (as sider himself
    ...
    - why should we suppose that 'exist' is ambiguous?  why not
      ...
      talk?
  - [ ] does his truth-condition argument commit him to a claim about
    meaning?
  - [ ] is that claim "ted was a boy" means "ted has a
    stage-counterpart..."?
...
- [ ] chisholm's definitions seem to suggest that entia successiva are
  _things_
  - [ ] should we take chisholm to be giving us 'loose' definitions,
  ...
  - [ ] work through chisholm's 'paraphrases' more carefully
  - [ ] equivalence classes?
**** TODO functions
