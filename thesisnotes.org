...
- [ ] set membership
  - [ ] temperature rising; make it more precise (x will be referent
    of 's' and y is referent of 's' and x is greater than y)
  - [ ] same for supreme court diversity
**** TODO structure
- [ ] how can I keep the stuff on the Supreme Court?
- [ ] run the new arg twice
  - [ ] groups
  - [ ] sums
...
- [ ] whither common sense?
  - [ ] common sense and systematicity
**** TODO change parts
- [ ] van Inwagen's argument against change assumes flatness?
- [ ] four-dimensional
- [ ] part-whole bridge from 'no co-location' to 'flatness'
** Stroud
