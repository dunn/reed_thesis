...
that there are bligers.  Van Inwagen relied too heavily on the notion
of `composition', and as a result concluded that ``there are bligers''
was not only less than obviously true, but actually false.
