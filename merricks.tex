...
(Recall my sample uses of `dogbush' above, in which there were six,
and then later five, dogbushes in the park.  If at any point there
were none, that would be because the dogs had all left their trees.)
...
\begin{enumerate}[ref=(\arabic*)]
  ...
  \item If there is something common to all parthood relations, does
    this show that a set is a {\em thing} in the same sense as a chair
    is a thing?  One reason to distinguish different {\em kinds} of
    thing is the idea that things like sets are {\em abstract}
    objects.  If I am the only part of my singleton (the set that
    contains only me), what is the difference between me and my
    singleton?  Can I {\em see} my singleton?  Or does it have
    another, abstract, part that is not visible? \label{part2}
...
kinds of thing---material things like bread, immaterial wishes, groups
and sets.
...
there is a sense in which we are the same: we both have the same
parts.  I am the only improper part of me, and I am the only member of
my singleton.
...
relationships of $k$-part for $k$ in $K$ \citeyearpar[579]{fine2010}.
\end{squote}

My hand might therefore be a \textepsilon ,$m$-part of my singleton,
but not a part in the set-theoretic sense.
