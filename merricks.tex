...
why we believe that there are chairs fails too.  The lesson of
Merricks' nihilism is that misguided talk of `composition' makes
nihilism seem more plausible that it is; in fact, {\em universalism}
is a vastly more plausible thesis.
...
section \ref{english}).  For there to be minions, nothing is required
over and above there being things arranged minionwise.  ``There are
minions'' is true iff ``there are things arranged minionwise'' is
true.
...
now there is an obvious counterargument against Merricks.  Just
because dogbushes do {\em not} interest us, we should not therefore
suppose that there are not dogbushes.  What interests us should not be
a guide to what exists.
...
Much of the resistance to this theses (at least, much of my early
...
\section{Problems for universalism}
