...
\paragraph{The curious archipelago}
This example is based on something by John Hawthorne
...
\begin{description}
  \item[Application] The application conditions are ``the conditions
    ...
    more limited; and other operations will be more restricted still.
...
What is the relation between groups and teams?  Are teams groups that
have been `baptized' in a certain way (through official recognition,
or some other ritual)?  Or are teams a different kind of entity
altogether?
