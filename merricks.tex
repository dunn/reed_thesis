...
things arranged statuewise composed a statue, he write:
...
Of course, I disagree.  The question ``whether things arranged
statuewise compose a statue'' is equivalent to the question whether
there are statues.  The answer to both is ``yes'', and this just {\em
...
from \ref{fwise}: ``There is an $F$'' is true if and only if ``There
are things arranged $F$-wise'' is true.
